            ...
            <div className="flex gap-4 justify-center flex-wrap lg:gap-0">
              {
                tabData.map(({ label, tab_active }) => {
                  const buttonCss = `cursor-pointer text-md uppercase rounded-tl-[2rem] rounded-br-[2rem] border-0 border-l-2 border-white outline-none bg-transparent hover:bg-green-500 shadow-neon hover:shadow-hoverNeon hover:border-white text-show text-white font-bold w-[10rem] py-2 font-serif duration-300 ease-in-out  ${tab_active ? "shadow-hoverNeon bg-green-500 border-white" : "border-green-500"}`;
